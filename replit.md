...
- **PSD Export with Editable Text Layers**: Generates layered PSD files with fully editable text (Montserrat fonts, responsive sizing, exact XY positioning). API endpoints provide PSD capabilities and metadata.
