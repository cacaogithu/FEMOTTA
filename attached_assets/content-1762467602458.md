[Skip to main content](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#main-content)
...
- [English](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools)
- [Deutsch](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=de)
- [Español – América Latina](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=es-419)
- [Français](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=fr)
- [Indonesia](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=id)
- [Italiano](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=it)
- [Polski](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=pl)
- [Português – Brasil](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=pt-br)
- [Shqip](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=sq)
- [Tiếng Việt](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=vi)
- [Türkçe](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=tr)
- [Русский](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=ru)
- [עברית](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=he)
- [العربيّة](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=ar)
- [فارسی](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=fa)
- [हिंदी](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=hi)
- [বাংলা](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=bn)
- [ภาษาไทย](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=th)
- [中文 – 简体](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=zh-cn)
- [中文 – 繁體](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=zh-tw)
- [日本語](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=ja)
- [한국어](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools&hl=ko)
...
[Sign in](https://ai.google.dev/_d/signin?continue=https%3A%2F%2Fai.google.dev%2Fgemini-api%2Fdocs%2Fbatch-api%3Futm_source%3DAISgaias%26utm_medium%3Demail%26utm_campaign%3DAPI-tools&prompt=select_account)

- On this page
- [Creating a batch job](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#create-batch-job)
  - [Inline requests](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#inline-requests)
  - [Input file](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#input-file)
  - [Batch embedding support](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#batch-embedding)
  - [Request configuration](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#request-config)
- [Monitoring job status](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#batch-job-status)
- [Retrieving results](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#retrieve-batch-results)
- [Cancelling a batch job](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#canceling-batch-job)
- [Deleting a batch job](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#delete-batch-job)
- [Technical details](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#technical-details)
- [Best practices](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#best-practices)
- [What's next](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#whats-next)
...
- **[Inline Requests](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#inline-requests):** A list of
...
- **[Input File](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#input-file):** A [JSON Lines (JSONL)](https://jsonlines.org/)
...
[Python](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#python)[JavaScript](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#javascript)[REST](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#rest)More
...
for [monitoring](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#batch-job-status) the job status as well as
[retrieving the results](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#retrieve-batch-results) once the job completes.
...
To create an embeddings batch job with either [inline requests](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#inline-requests)
or [input files](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#input-file), use the `batches.create_embeddings` API and
specify the embeddings model.

[Python](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#python)[JavaScript](https://ai.google.dev/gemini-api/docs/batch-api?utm_source=AISgaias&utm_medium=email&utm_campaign=API-tools#javascript)More
